...
echo -e "\n==> docker run"
docker run --name $dh_image_name --restart=always --net=nginxproxymanager_default --user 1006:1006 -d -v /home/$dh_image_name/short_urls.sqlite3:/app/short_urls.sqlite3 $dh_username/$dh_image_name:latest
echo -e "\n==> Container info"
